...
if (HttpContext.Current.Request.HttpMethod == "GET")
{
    if (Request.QueryString.ToString().Length == 0) {
        ...
        Response.Write("{\"message\": \"Código do Produto é um parametro obrigatorio e não for informado. Exemplo: http://integracao.altamira.com.br/manufacturing/process?code=PPLCOL00113000000000.\"}");
        return;
    }
    ...
    using (SqlConnection connection = new SqlConnection("Server=(local);Database=INTEGRACAO;User Id=integracao;Password=#35az09@;"))
    {
        ...
        using (SqlCommand cmd = new SqlCommand("MANUFACTURING_PROCESS"))
        {
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@code", Request.QueryString.ToString());
            ...
            if (json == null || json == "")
            {
                        ...
                        Response.Write("{\"message\": \"Produto não encontrado !\"}");
            } else {
