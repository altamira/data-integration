...
( NAME = N'INTEGRACAO', FILENAME = N'C:\INTEGRACAO.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'INTEGRACAO_log', FILENAME = N'C:\INTEGRACAO_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
